...
class AutoDeactivateWarning extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($warnings as $warning) {
            ...
            $pm->message = 'The [b]WARNING[/b] you received relating to torrent '.$warning->torrenttitle->name.' has expired! Try not to get more!<br>[color=red][b]THIS IS AN AUTOMATED SYSTEM MESSAGE, PLEASE DO NOT REPLY![/b][/color]';
            $pm->save();
        }
